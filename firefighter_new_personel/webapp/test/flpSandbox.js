		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Firefighter New Personel",
									"targetURL": "#firefighternewpersonel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"firefighternewpersonel-display": {
								"semanticObject": "firefighternewpersonel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=firefighternewpersonel",
									"url": sap.ui.require.toUrl("firefighternewpersonel")
								}
							}
						}
					}
